...
import 'package:chronova_app/widgets/home_bar.dart'; // We use BottomBarMenu for the logged-in state
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<User?>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          // So, show the main screen with the bottom navigation bar
          return const BottomBarMenu();
        }
