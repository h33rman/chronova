// File: lib/config/app_color_schemes.dart
...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      inversePrimary: Color(0xffe1b8f5),
      primaryFixed: Color(0xfff5d9ff),
      onPrimaryFixed: Color(0xff2c0b3f),
      primaryFixedDim: Color(0xffe1b8f5),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.light,
      primary: Color(0xff3e1e51),
      surfaceTint: Color(0xff735187),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff5d3c70),
      onPrimaryContainer: Color(0xffffffff),
      ...
      inverseSurface: Color(0xff332f35),
      inversePrimary: Color(0xffe1b8f5),
      primaryFixed: Color(0xff5d3c70),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff452558),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff524458),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff3a2e40),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xffa883bc),
      ...
      primaryFixedDim: Color(0xffe1b8f5),
      onPrimaryFixedVariant: Color(0xff48285b),
      secondaryFixed: Color(0xfff0dcf5),
      onSecondaryFixed: Color(0xff170d1d),
      secondaryFixedDim: Color(0xffd3c0d8),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xfffcebff),
      surfaceTint: Color(0xffe1b8f5),
      onPrimary: Color(0xff000000),
      primaryContainer: Color(0xffddb4f1),
      onPrimaryContainer: Color(0xff180028),
      secondary: Color(0xfffcebff),
      ...
      secondaryFixedDim: Color(0xffd3c0d8),
      onSecondaryFixedVariant: Color(0xff170d1d),
      tertiaryFixed: Color(0xffffdada),
